# Contributing to mtl-pedalboard
...
1. Check existing [issues](https://github.com/musictechlab/mtl-pedalboard/issues)
   to avoid duplicates
...
Open a [discussion](https://github.com/musictechlab/mtl-pedalboard/discussions)
